...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-21 13:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/79917a4d-6a64-4623-a552-c08dfa25f918.git
$ cd 79917a4d-6a64-4623-a552-c08dfa25f918
```
